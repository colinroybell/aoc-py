...
class Test_2021_18:
    ...
    def test_bringup_a_parse_line(self):
        node = Node.parse_line("[[[[1,3],[5,3]],[[1,3],[8,7]]],[[[4,9],[6,9]],[[8,2],[7,3]]]]") 
        assert node.string() == "[[[[1,3],[5,3]],[[1,3],[8,7]]],[[[4,9],[6,9]],[[8,2],[7,3]]]]"   
    ...
    def test_bringup_a_5(self):
        ...
        assert self.day.run_part("a",["[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]"])==3488
