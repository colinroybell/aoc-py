...
class State:
    ...
    def move_room_room_cost_if_possible(self,r1,r2):
        ...
        for i in range(min_,max_+1):
            if self.hall[i] != '.':
                return None
        return max_ - min_ + State.room_length+1-len(self.rooms[r1]) + State.room_length-len(self.rooms[r2])
        ...
        for r in range(4):
            ...
            if self.valid_move_to_room(target_room):
                ...
                if cost:
                    ...
                    if len(state.rooms[target_room]) == State.room_length and state.rooms[target_room][0] == 'X':
                        state.rooms_done += 1
