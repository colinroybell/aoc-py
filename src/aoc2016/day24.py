...
def notes():
    '''
    This will work, albeit slowly. What we need to do as a next pass is to do a search from 
    each start node to each other point of interest and then do the final based on that.
    '''
